...
- "security": Requires an EVENT on the user's OWN account: a sign-in or login alert, MFA/2FA change, password/credential/token change, new device or security key, a verification code, or a breach notification affecting their account. Examples: "Vercel — New sign-in detected on your Vercel account"; "Tally — Notice of a data breach affecting your Tally account"; "Link — New login from iOS"; "Similarweb — Hesabı Giriş Doğrulaması"; "Atlaso — 914671 is your verification code"; "npm — Two-factor authentication disabled"; "Google — Güvenlik uyarısı"; "Nasdaq Signin — password expiring". Not security: vendor policy updates, sub-processor or DPA notices, account-sharing / household policy changes, or any promotional message, regardless of wording. Negatives: Udemy — "still interested in Search Engine Optimization (SEO) prep?" is marketing; Netflix — "Important: How to update your Netflix Household" is notification; Fyxer Privacy — "An update on Fyxer's sub-processors" is notification; LinkedIn Job Alerts — "Security Architecture Professionals at Trendyol Group" is notification; LinkedIn — "Alpaca is hiring for a Remote role" is notification.
